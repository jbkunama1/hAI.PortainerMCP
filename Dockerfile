# Syntax: Dockerfile for the Portainer MCP auth proxy container
...
# Standard-Umgebungsvariablen (können zur Laufzeit ueberschrieben werden)
...
# Startkommando: Node.js-Proxy ausfuehren
